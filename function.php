<?php
define('DB_SERVER', 'localhost'); //กำหนด hostname password เพื่อติดต่อกับ server
define('DB_USER' , 'root');
define('DB_PASS' , '');
...
class DB_con{
    ...
    function __construct(){
        ...
        if(mysqli_connect_error()){
            echo "Falied to caonnect to MySQL : " .mysqli_connect_error();
        }
    }

public function insert($firstname,$lastname,$email,$phonenumber,$address){
    $result = mysqli_query($this->dbcon, "INSERT INTO tblusers(firstname,lastname,email,phonenumber,address) 
